export default {
    component : {
        ...
        // 进度条<i class="tag new"></i> : '1',
        // 折叠<i class="tag new"></i> : '3',
        // 滚动跟随<i class="tag update"></i> : '2',
